...
func paramReaderImplied(_ paramMemReader, _ bool) ([]any, []byte, bool) {
	return nil, nil, false
}

func paramReaderImmediate(mem paramMemReader, _ bool) ([]any, []byte, bool) {
	b := mem.Read(*PC + 1)
	params := []any{int(b)}
	opcodes := []byte{b}
...
func paramReaderAccumulator(_ paramMemReader, _ bool) ([]any, []byte, bool) {
	params := []any{Accumulator(0)}
	return params, nil, false
}

func paramReaderAbsolute(mem paramMemReader, _ bool) ([]any, []byte, bool) {
...
func paramReaderAbsoluteX(mem paramMemReader, _ bool) ([]any, []byte, bool) {
	b1 := uint16(mem.Read(*PC + 1))
	b2 := uint16(mem.Read(*PC + 2))
	w := b2<<8 | b1
...
func paramReaderAbsoluteY(mem paramMemReader, _ bool) ([]any, []byte, bool) {
	b1 := uint16(mem.Read(*PC + 1))
	b2 := uint16(mem.Read(*PC + 2))
	w := b2<<8 | b1
...
func paramReaderZeroPage(mem paramMemReader, _ bool) ([]any, []byte, bool) {
	b := mem.Read(*PC + 1)
...
func paramReaderZeroPageX(mem paramMemReader, _ bool) ([]any, []byte, bool) {
	b := mem.Read(*PC + 1)
...
func paramReaderZeroPageY(mem paramMemReader, _ bool) ([]any, []byte, bool) {
	b := mem.Read(*PC + 1)
...
func paramReaderRelative(mem paramMemReader, _ bool) ([]any, []byte, bool) {
...
func paramReaderIndirect(mem paramMemReader, _ bool) ([]any, []byte, bool) {
